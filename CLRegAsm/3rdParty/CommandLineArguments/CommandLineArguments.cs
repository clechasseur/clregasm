...
//    Modified by: Charles Lechasseur
//
...
//          2014 [CLP] Added support for optional values
//////////////////////////////////////////////////////////////////////////////
...
namespace CommandLineArguments
{
    ...
    public enum ArgumentType
    {
        ...
        Multiple        = 0x04,
        /// <summary>
        /// Indicates that the argument may have a value, but it is optional.
        /// If the value is omitted, it will be set to its UnspecifiedValue.
        /// </summary>
        OptionalValue   = 0x08,
    ...
    public class ArgumentAttribute : Attribute
    {
        ...
        /// <summary>
        /// The unspecified value of the argument. This is used when
        /// <see cref="Flags.OptionalValue"/> is specified in
        /// <see cref="ArgumentAttribute.Type"/>
        /// </summary>
        public object UnspecifiedValue
        {
            get { return this.unspecifiedValue; }
            set { this.unspecifiedValue = value; }
        }
        ...
        /// <summary>
        /// Returns true if the argument has an unspecified value.
        /// </summary>
        public bool HasUnspecifiedValue { get { return null != this.unspecifiedValue; } }
        ...
        private object unspecifiedValue;
    ...
    public sealed class Parser
    {
        ...
        public static int GetConsoleWindowWidth()
        {
            ...
            // Dummy assignments to prevent warning
            csbi.dwSize.x = 0;
            csbi.dwSize.y = 0;
        ...
        private static object UnspecifiedValue(ArgumentAttribute attribute, FieldInfo field)
        {
            return (attribute == null || !attribute.HasUnspecifiedValue) ? null : attribute.UnspecifiedValue;
        }
        ...
        private class Argument
        {
            public Argument(ArgumentAttribute attribute, FieldInfo field, ErrorReporter reporter)
            {
                ...
                this.unspecifiedValue = Parser.UnspecifiedValue(attribute, field);
                this.elementType = ElementType(field);
                this.flags = Flags(attribute, field);
                this.field = field;
                this.seenArgument = false;
                this.reporter = reporter;
                ...
                Debug.Assert(!(this.IsRequired && this.HasUnspecifiedValue), "Required arguments cannot have unspecified value");
                Debug.Assert(!this.HasDefaultValue || (this.defaultValue.GetType() == field.FieldType),
                    "Type of default value must match field type");
                Debug.Assert(!this.HasUnspecifiedValue || (this.UnspecifiedValue.GetType() == field.FieldType),
                    "Type of unspecified value must match field type");
                Debug.Assert(!this.HasUnspecifiedValue || this.OptionalValue,
                    "Unspecified value can only be used in conjunction with OptionalValue");
                Debug.Assert(this.Type != typeof(bool) || !this.OptionalValue, "Bool arguments cannot use OptionalValue");
                Debug.Assert(!this.IsCollection || !this.OptionalValue, "Collection arguments cannot use OptionalValue");
                Debug.Assert(!this.IsDefault || !this.OptionalValue, "Default arguments cannot use OptionalValue");
            }
            
            public bool Finish(object destination)
            {
                if (!this.SeenArgument && this.HasDefaultValue)
                {
            ...
            {
                if (this.IsRequired && !this.SeenArgument)
                {
                    if (this.IsDefault)
            ...
            {
                // null is only valid for bool variables, empty string is never valid (except for optional values)
                if (((stringData != null || type == typeof(bool)) && (stringData == null || stringData.Length > 0)) || this.OptionalValue)
                {
                    try
                    {
                        if (stringData == null && this.HasUnspecifiedValue)
                        {
                            Debug.Assert(type != typeof(bool));
                            value = this.UnspecifiedValue;
                            return true;
                        }
                        ...
                        else
                        {
                            ...
                            {
                                value = Convert.ChangeType((int) 0, type);
                            }
                            return true;
                        }
                    }
            ...
            {
                get { return null != this.unspecifiedValue; }
            }
            ...
            public bool SeenArgument
            {
                get { return this.seenArgument; }
            }
            ...
            {
                get { return 0 != (this.flags & ArgumentType.OptionalValue); }
            }
